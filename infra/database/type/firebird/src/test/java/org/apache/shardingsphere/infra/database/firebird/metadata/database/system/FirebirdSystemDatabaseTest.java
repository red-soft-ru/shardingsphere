...
class FirebirdSystemDatabaseTest {
    ...
    void assertGetSystemDatabases() {
        ...
        assertTrue(systemDatabase.getSystemDatabaseSchemaMap().containsKey("firebird"));
    ...
    void assertGetSystemSchemas() {
        assertThat(systemDatabase.getSystemSchemas(), is(new HashSet<>(Arrays.asList("information_schema", "performance_schema", "firebird", "sys", "shardingsphere"))));
    }
}
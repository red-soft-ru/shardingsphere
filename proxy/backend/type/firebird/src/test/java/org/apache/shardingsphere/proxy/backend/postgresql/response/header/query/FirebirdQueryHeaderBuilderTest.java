...
import org.apache.shardingsphere.proxy.backend.firebird.response.header.query.FirebirdQueryHeaderBuilder;
...
class FirebirdQueryHeaderBuilderTest {
    ...
    void assertBuildPostgreSQLQueryHeader() throws SQLException {
        ...
        QueryHeader actual = new FirebirdQueryHeaderBuilder().build(queryResultMetaData, null, null, queryResultMetaData.getColumnLabel(columnIndex), columnIndex);

...
import org.apache.shardingsphere.db.protocol.firebird.packet.command.query.binary.statement.FirebirdAllocateStatementPacket;
...
import org.apache.shardingsphere.db.protocol.firebird.packet.command.query.binary.transaction.FirebirdStartTransactionPacket;
...
import org.apache.shardingsphere.proxy.frontend.firebird.command.admin.info.FirebirdDatabaseInfoExecutor;
    ...
    public static CommandExecutor newInstance(final FirebirdCommandPacketType commandPacketType, final FirebirdCommandPacket commandPacket,
        ...
        switch (commandPacketType) {
            case OP_INFO_DATABASE:
                return new FirebirdDatabaseInfoExecutor((FirebirdDatabaseInfoPacket) commandPacket);
            case OP_TRANSACTION:

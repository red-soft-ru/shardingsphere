...
package org.apache.shardingsphere.proxy.frontend.firebird.command.admin.info;
...
import org.apache.shardingsphere.db.protocol.firebird.packet.command.admin.info.FirebirdDatabaseInfoPacket;
        ...
        for (int code : packet.getInfoItems()) {
            ...
            switch (code) {
                ...
                case ISCConstants.isc_info_end:
                    data.writeByte(ISCConstants.isc_info_end);
                    break;
                default:
                    throw new FirebirdProtocolException("Unknown database information request type %d", code);
            }
        }
